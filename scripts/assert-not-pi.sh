...
#
# This matters because Claude Code is installed on the Pi (family-dashboard
# PI_SETUP.md, Part 17) and picks up CLAUDE.md automatically, whose build order
# says mutation tests are mandatory. The carve-out is documented there; this is
# the backstop that catches a session which missed it.
#
